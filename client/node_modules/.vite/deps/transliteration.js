...
a = void 0;
var s = { ignore: [], replace: [], replaceAfter: [], trim: false, unknown: "", fixChineseSpacing: true };
var y = class {
  ...
  setData(a2, n2 = false) {
    if (n2 && (this.map = o(i)), a2 && "object" == typeof a2 && Object.keys(a2).length) {
      this.map = o(this.map);
      for (const i2 in a2)
        Object.prototype.hasOwnProperty.call(a2, i2) && i2.length < 3 && i2 <= "􏿿" && (this.map[i2] = a2[i2]);
    }
    return this.map;
  }
  transliterate(a2, i2) {
...
var l = Object.assign(Object.assign({}, o(s)), { allowedChars: "a-zA-Z0-9-_.~", lowercase: true, separator: "-", uppercase: false, fixChineseSpacing: true });
var b = new y();
var w = b.transliterate.bind(b);
w.config = b.config.bind(b), w.setData = b.setData.bind(b);
var j = new class extends y {
  get options() {
