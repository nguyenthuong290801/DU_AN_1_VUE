<template>
  <section id="section">
    <form class="p-2" @submit.prevent="submitProduct">
      <div class="row">
        <div class="col-12 container-box bg-white" @dragover.prevent>
      ...
      <div class="row">
        <div class="col-12 container-box bg-white">
      ...
      <div class="row sticky-button">
        <div class="col-12 container-box bg-light">
          <button class="float-end bt-primary-ac" type="submit">Lưu sản phẩm</button>
        </div>
      </div>
    </form>
  </section>
  <div class="modal-success" v-if="showSuccessModal"> Đã thêm thành công!</div>
</template>
