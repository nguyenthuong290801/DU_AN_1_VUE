<template>
    ...
    <div class="row detail-page-a">
      ...
      <div class="col-md-7 detail-page-c">
        <div class="detail-page-c-a">
          <div class="detail-page-c-a-01">
            <span>[Mã FATRENDJAN giảm tới 30k đơn 99k] Áo Sơ Mi Nhung Tăm Nữ Form Rộng Nâu Be Siêu Hot</span>
          </div>
          ...
          <div class="detail-page-c-a-03">
            <div class="detail-page-c-a-03-a">
              <div class="d-flex detail-page-c-a-03-text">
                ...
                <div class="detail-page-c-a-03-text-02">89.000</div>
                ...
                <div class="d-flex detail-page-c-a-07-a-text-01">
                  <div class="amount-product" style="margin-right: 15px">
                    <div class="amount-product-a">
                      <button class="amount-product-button"><i class="bi bi-dash-lg" style="color: #999999"></i>
                      </button>
                      <input class="amount-product-input" type="text" value="1">
                      <button class="amount-product-button"><i class="bi bi-plus" style="color: #999999"></i></button>
                    </div>
                  </div>
                  <div style="margin-left: 10px;">254367 sản phẩm có sẵn</div>
                </div>
              </div>
            </div>
          </div>
          <div class="detail-page-c-cart">
            <button type="button" class="detail-page-c-cart-a detail-page-c-cart-aa"><i class="bi bi-plus"></i> Thêm Vào
              Giỏ Hàng
            </button>
        ...
        <div class="box-title">
          ...
          <div class="list-danhmuc mx-4">
            <p><span class=" p-1 text-secondary">Thông tin chi tiết của sản phẩm áo/Quần Jean/Kaki <br>
                                  ...
                                  - Áo/Quần  Nam/Nữ đẹp phong cách Hàn Quốc hiện đại giúp bạn phát huy được sự cá tính, năng động của bản thân.<br>
  ...
  - Không nên giặt Áo/Quần Jean/Kaki bằng máy giặt bởi điều này rất dễ làm hỏng vải áo. Với áo khoác bạn không phải giặt thường xuyên có thể giặt vài tuần 1 lần tùy vào tình trạng bám bẩn hoặc mức độ bạn sử dụng ngoài đường nhiều hay ít.
  - Không ngâm đồ trong xà phòng, nước giặt quá lâu, không nên sử dụng các chất tẩy rửa
  - Không nên để áo ở những nơi ẩm ướt, với tính chất hút ẩm, hút nước tốt, áo thun dễ bị ẩm mốc, thậm chí để lại những vết ố trên vải áo.
                              </span></p>
  ...
  - Đổi trả theo quy định của sàn
      ...
      <aside class="col-md-3 list-top-item">
        ...
        <div class="detail-page-c-a-04-a-text-02 d-block pipe2 d-flex mt-3 justify-content-around"
             style="height: 120px">
