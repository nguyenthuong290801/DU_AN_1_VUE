    ...
    <div class="shipdiscount" role="main" style="margin-bottom: 0">
      <div class="shipping-discount">
        <img
            ...
            src="../assets/img/shipping-car.png"
        />
        <span class="bXROAg"
        >Nhấn vào mục Mã giảm giá ở cuối trang để hưởng miễn phí vận chuyển bạn nhé!</span
        >
      </div>
      <div class="BjIo5w">
        <div class="mcsiKT">
          ...
          <div class="wholepleake">
            ...
            <div class="wJCpl6 mx-2">
              <svg width="62" height="16" fill="none">
                <path fill="#ee4d2d" fill-rule="evenodd" d="M0 2C0 .9.9 0 2 0h58a2 2 0 012 2v12a2 2 0 01-2 2H2a2 2 0 01-2-2V2z"></path>
                <g clip-path="">
